...
DECLARE
	reserved_roles varchar[] := ARRAY['sysadmin', 'securityadmin',
                                    'master_dbo', 'master_guest', 'master_db_owner', 'master_db_accessadmin', 'master_db_ddladmin',
                                    'tempdb_dbo', 'tempdb_guest', 'tempdb_db_owner',  'tempdb_db_accessadmin', 'tempdb_db_ddladmin',
                                    'msdb_dbo', 'msdb_guest', 'msdb_db_owner', 'msdb_db_accessadmin', 'msdb_db_ddladmin'];
