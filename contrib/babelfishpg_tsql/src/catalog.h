...
extern void add_entry_to_bbf_schema_perms(const char *schema_name, const char *object_name, int permission, const char *grantee, const char *object_type, const char *func_args, const char *grantor, bool grant_option);
extern bool privilege_exists_in_bbf_schema_permissions(const char *schema_name, const char *object_name, const char *grantee, const char *object_type, const char *grantor, bool grant_option);
extern void update_privileges_of_object(const char *schema_name, const char *object_name, int new_permission, const char *grantee, const char *object_type, bool is_grant, const char *grantor, bool grant_option);
extern void remove_entry_from_bbf_schema_perms(const char *schema_name, const char *object_name, const char *grantee, const char *object_type, const char *grantor, bool grant_option);
extern void add_or_update_object_in_bbf_schema(const char *schema_name, const char *object_name, int new_permission, const char *grantee, const char *object_type, bool is_grant, const char *func_args, const char *grantor, bool grant_option);
extern int get_privilege_of_object(const char *schema_name, const char *object_name, const char *grantee, const char *object_type, const char *grantor, bool grant_option);
