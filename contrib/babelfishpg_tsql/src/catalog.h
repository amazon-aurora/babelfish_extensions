...
extern void update_privileges_of_object(Relation bbf_schema_rel, const char *schema_name, const char *object_name, int new_permission, const char *grantee, const char *object_type, bool is_grant, const char *grantor, bool grant_option);
extern void remove_entry_from_bbf_schema_perms(Relation bbf_schema_rel, const char *schema_name, const char *object_name, const char *grantee, const char *object_type, const char *grantor, bool grant_option);
extern void add_or_update_object_in_bbf_schema(Relation bbf_schema_rel, const char *schema_name, const char *object_name, int new_permission, const char *grantee, const char *object_type, bool is_grant, const char *func_args, const char *grantor, bool grant_option);
